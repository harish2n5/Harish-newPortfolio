...
import {
  ...
  ExternalLink, FileDown, PenTool, Code2, Layers, BarChart3, Smartphone,
  Globe, CheckCircle2, Zap, Clock, Shield, Heart, Sparkles, Check
} from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-background text-foreground font-sans selection:bg-primary selection:text-black">
      ...
      {/* ── 1. HERO SECTION (Full Image + High Contrast Text) ─────── */}
      <section id="hero" className="relative min-h-[92vh] flex items-center justify-center overflow-hidden border-b-[4px] border-black bg-black">
        {/* Full Hero Image Background */}
        <div className="absolute inset-0 z-0">
          <img
            src={HERO_IMAGE}
            alt="Harish — UI/UX Designer & Full Stack Developer"
            className="w-full h-full object-cover object-center scale-105 filter brightness-[0.7] contrast-125"
            data-testid="img-hero-full-bg"
          />
          {/* High Contrast Vignette / Gradients */}
          <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-black/30" />
          <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/75 to-transparent" />
        </div>

        {/* Content Container */}
        <div className="relative z-10 max-w-6xl w-full mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-28 flex flex-col justify-center">
          <div className="max-w-3xl">
            ...
            <div className="perspective-[800px] mb-6">
              {[
                { text: "I DESIGN.", color: "text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]" },
                { text: "I CODE.", color: "text-secondary drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]" },
                { text: "I SHIP.", color: "text-primary drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]" },
              ].map((line, li) => (
                <motion.div
                  key={li}
                  ...
                  className={`flex overflow-hidden text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black uppercase tracking-tighter leading-[0.85] ${line.color}`}
            ...
            {/* High Contrast Bio Box */}
            <motion.div
              initial={{ opacity: 0, x: -30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.7, duration: 0.5 }}
              className="border-[3px] border-black bg-black/90 backdrop-blur-md p-6 sm:p-8 brutal-shadow max-w-2xl mb-8"
              style={{ boxShadow: "6px 6px 0px #CCFF00" }}
            >
              <p className="text-base sm:text-lg md:text-xl font-mono text-white leading-relaxed border-l-[4px] border-primary pl-4">
            ...
            >
              <motion.a
                ...
                className="inline-flex items-center gap-3 font-bold uppercase text-base sm:text-lg border-[3px] border-black bg-primary text-black px-8 py-4 brutal-shadow cursor-pointer hover:bg-white transition-colors"
              >
              ...
              <motion.a
                ...
                whileHover={{ x: -4, y: -4, boxShadow: "8px 8px 0px #000" }}
                whileTap={{ x: 1, y: 1, boxShadow: "2px 2px 0px #000" }}
                className="inline-flex items-center gap-3 font-bold uppercase text-base sm:text-lg border-[3px] border-black bg-secondary text-black px-8 py-4 brutal-shadow cursor-pointer hover:bg-white transition-colors"
              >
                Hire Me
              </motion.a>
              <motion.a
                ...
                whileHover={{ x: -4, y: -4, boxShadow: "8px 8px 0px #000" }}
                whileTap={{ x: 1, y: 1, boxShadow: "2px 2px 0px #000" }}
                className="inline-flex items-center gap-2 font-bold uppercase text-base border-[3px] border-black bg-white text-black px-6 py-4 brutal-shadow hover:bg-primary transition-colors cursor-pointer"
              >
            ...
            <motion.div
              ...
              className="mt-10 inline-flex items-center gap-3 bg-black/90 border-[2px] border-white/30 text-white font-mono text-xs uppercase tracking-wider px-4 py-2 brutal-shadow"
            >
      ...
      <section id="about" className="px-4 sm:px-6 py-16 sm:py-24 border-b-[3px] border-black bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <SectionWrapper>
            ...
            <motion.h2 variants={slideUp} className="text-4xl sm:text-6xl lg:text-8xl font-black uppercase tracking-tighter mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-start mb-20">
            ...
            <SectionWrapper className="space-y-6">
              <h3 className="text-2xl sm:text-3xl font-black uppercase tracking-tight mb-4 border-b-[3px] border-black pb-3">The Story</h3>
          ...
          {/* Core Values ("What I Stand For") */}
          <div className="mt-16 pt-12 border-t-[3px] border-black">
            <SectionWrapper>
              <motion.h3 variants={slideUp} className="text-3xl sm:text-5xl font-black uppercase tracking-tighter mb-12">
                What I Stand For.
              </motion.h3>
            </SectionWrapper>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {values.map((val, i) => (
                <motion.div
                  ...
                  transition={{ delay: i * 0.1 }}
                  whileHover={{ x: -4, y: -4, boxShadow: "8px 8px 0px #000" }}
                  className="border-[3px] border-black bg-background p-8 brutal-shadow"
                  data-testid={`value-card-${i}`}
                >
                  <div className="w-12 h-12 border-[3px] border-black bg-primary flex items-center justify-center mb-6">
                    <val.icon className="w-6 h-6 text-black" />
                  </div>
                  <h4 className="text-2xl font-black uppercase tracking-tight mb-3">{val.title}</h4>
                  <p className="font-mono text-base leading-relaxed text-gray-800">{val.body}</p>
                </motion.div>
              ))}
            </div>
          </div>
      ...
      {/* ── 5. THE STACK / TOOLKIT ────────────────────────────────── */}
      <section className="px-4 sm:px-6 py-16 sm:py-24 border-b-[3px] border-black bg-background">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
          <div>
            <motion.h2
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-4xl sm:text-6xl lg:text-7xl font-black uppercase tracking-tighter mb-6"
            >
              The Stack.
            </motion.h2>
            <motion.p
      ...
      <section id="services" className="px-4 sm:px-6 py-16 sm:py-24 border-b-[3px] border-black bg-white">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <SectionWrapper>
            <motion.p variants={slideUp} className="font-mono text-sm sm:text-base uppercase tracking-widest mb-3 text-muted-foreground">
            ...
            <motion.h2 variants={slideUp} className="text-4xl sm:text-6xl lg:text-8xl font-black uppercase tracking-tighter mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {differentiators.map((d, i) => (
                  ...
                  >
                    ...
                    <h4 className="text-xl font-black uppercase tracking-tight mb-3">{d.title}</h4>
      ...
      <section id="work" className="px-4 sm:px-6 py-16 sm:py-24 border-b-[3px] border-black bg-background">
        <div className="max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div>
              ...
              <h2 className="text-4xl sm:text-6xl lg:text-8xl font-black uppercase tracking-tighter leading-none">Selected Work.</h2>
            </div>
            <motion.a
              href="/work"
      ...
      <section id="contact" className="px-4 sm:px-6 py-16 sm:py-24 border-t-[3px] border-black bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <motion.h2
              ...
              className="text-4xl sm:text-6xl lg:text-7xl font-black uppercase tracking-tighter leading-none mb-8"
            >
              Let's Build<br />
            ...
            >
              {[
                ...
                <motion.a
                  ...
                  whileHover={{ x: -3, y: -3, boxShadow: "6px 6px 0px #000" }}
                  whileTap={{ x: 1, y: 1, boxShadow: "2px 2px 0px #000" }}
                  className={`flex items-center gap-4 border-[3px] border-black bg-background px-6 py-4 font-bold uppercase brutal-shadow transition-colors text-black ${item.color}`}
                >
